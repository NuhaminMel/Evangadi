  ...
  return (
    <main className="h-full">
      <div className=" hero h-screen flex items-center justify-center md:pt-52">
        <div className=" w-10/12  md:w-7/12 text-center flex flex-col gap-5 md:gap-8 mt-12 md:mt-60">
      ...
      <div className="wave block -mt-36 w-full  relative overflow-hidden ">
          <svg className=" h-36  overflow-hidden w-full " data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
